...
class AddEmployeeDialog(simpledialog.Dialog):
    ...
    def apply(self):
        ...
        self.result = (name, id, department, job_title, basic_salary)
...
class Application(tk.Tk):
    ...
    def add_employee(self):
        ...
        if dialog.result:
            name, id, department, job_title, basic_salary = dialog.result
            self.sales_management.add_employee(name, id, department, job_title, basic_salary)
